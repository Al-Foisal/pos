            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.business_type.create') }}" class="btn btn-outline-primary">Add Business
                                Type</a>
                            <br>
                            <br>
                                    ...
                                    @foreach ($business_types as $item)
                                        <tr>
                                            <td class="d-flex justify-content-around">
                                                <a href="{{ route('admin.business_type.edit', $item) }}"
                                                    class="btn btn-info btn-xs"> <i class="fas fa-edit"></i> Edit</a>
                                                @if ($item->status == 1)
                                                    <form action="{{ route('admin.business_type.inactive', $item) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('admin.business_type.active', $item) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
