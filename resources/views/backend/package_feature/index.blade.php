...
@section('backend')
    <!-- Content Header (Package Feature header) -->
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Package Feature</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.package_feature.create') }}" class="btn btn-outline-primary">Add Package Feature</a>
                            <br>
                            <br>
                                    ...
                                    @foreach ($package_features as $item)
                                        <tr>
                                            <td class="d-flex justify-content-around">
                                                <a href="{{ route('admin.package_feature.edit', $item) }}"
                                                    class="btn btn-info btn-xs"> <i class="fas fa-edit"></i> Edit</a>
                                                @if ($item->status === 1)
                                                    <form action="{{ route('admin.package_feature.inactive', $item) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('admin.package_feature.active', $item) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
